export const patients = [
  ...
  },
  {
    ...
    age: 31,
    role: "Chef",
    symptom: "Obsessive guilt",
    mood: "burnt-gold",
    layers: ["Family Kitchen", "Service Rush", "Ash Pantry", "Cold Oven"],
    bossName: "The Empty Table",
  },
  {
    id: "selene",
    name: "Selene",
    ...
    mood: "void-indigo",
    layers: ["Observatory", "Falling Orbit", "Event Horizon", "Mute Constellation"],
    bossName: "The Last Signal",
  },
  {
    id: "igor",
    name: "Igor",
    age: 52,
    role: "Judge",
    symptom: "Memory suppression",
    mood: "marble-gray",
    layers: ["Chambers", "Archive Hall", "Verdict Pit", "Final Sentence"],
    bossName: "The Nameless Defendant",
  },
  {
    id: "noa",
    name: "Noa",
    age: 22,
    role: "Game streamer",
    symptom: "Identity split",
    mood: "glitch-neon",
    layers: ["Streaming Room", "Comment Flood", "Lag Cathedral", "Offline Screen"],
    bossName: "The Mirror Feed",
  },
  {
    id: "valen",
    name: "Valen",
    age: 60,
    role: "Poet",
    symptom: "Grief paralysis",
    mood: "paper-rust",
    layers: ["Library", "Rain Courtyard", "Broken Verse", "Blank Page"],
    bossName: "The Unfinished Line",
  },
];
